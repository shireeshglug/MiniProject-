...
model_digest_json = model.to_json()
with open("model_digest.json","w") as json_file:
    json_file.write(model_digest_json)
...
'''  End of training the model and testing  '''
...
# img = image.load_img("TestCase.jpeg", grayscale=True, target_size=(64, 64))
